...
public class SWIGTYPE_p_LLVMOpaquePassManager {
  ...
  protected SWIGTYPE_p_LLVMOpaquePassManager(long cPtr, @SuppressWarnings("unused") boolean futureUse) {
    swigCPtr = cPtr;
  }
  ...
  public boolean equals(Object obj) {
    boolean equal = false;
    if (obj instanceof SWIGTYPE_p_LLVMOpaquePassManager)
      equal = (((SWIGTYPE_p_LLVMOpaquePassManager)obj).swigCPtr == this.swigCPtr);
    return equal;
  }
