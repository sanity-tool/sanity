...
public final class LLVMLinkage {
  ...
  public final static LLVMLinkage LLVMLinkOnceODRAutoHideLinkage = new LLVMLinkage("LLVMLinkOnceODRAutoHideLinkage");
  ...
  public final static LLVMLinkage LLVMLinkerPrivateWeakLinkage = new LLVMLinkage("LLVMLinkerPrivateWeakLinkage");
  ...
  private static LLVMLinkage[] swigValues = { LLVMExternalLinkage, LLVMAvailableExternallyLinkage, LLVMLinkOnceAnyLinkage, LLVMLinkOnceODRLinkage, LLVMLinkOnceODRAutoHideLinkage, LLVMWeakAnyLinkage, LLVMWeakODRLinkage, LLVMAppendingLinkage, LLVMInternalLinkage, LLVMPrivateLinkage, LLVMDLLImportLinkage, LLVMDLLExportLinkage, LLVMExternalWeakLinkage, LLVMGhostLinkage, LLVMCommonLinkage, LLVMLinkerPrivateLinkage, LLVMLinkerPrivateWeakLinkage };
